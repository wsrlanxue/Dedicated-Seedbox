...
source <(wget -qO- https://raw.githubusercontent.com/wsrlanxue/Seedbox-Components/main/Miscellaneous/tput.sh)
...
source <(wget -qO- https://raw.githubusercontent.com/wsrlanxue/Seedbox-Components/main/seedbox_installation.sh)
Update
...
source <(wget -qO- https://raw.githubusercontent.com/wsrlanxue/Seedbox-Components/main/tweaking.sh)
CPU_Tweaking
NIC_Tweaking
...
wget https://raw.githubusercontent.com/wsrlanxue/Seedbox-Components/main/Miscellaneous/.boot-script.sh && chmod +x .boot-script.sh
